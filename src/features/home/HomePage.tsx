    ...
    <Box
      sx={{
        ...
        "& .vignette": {
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 50% 48%, rgba(10,25,36,0) 0%, rgba(10,25,36,0.15) 55%, rgba(5,12,18,0.6) 100%)",
          pointerEvents: "none",
          zIndex: 0,
        },
        "@keyframes gridMove": {
      ...
      <Box
        sx={{
          ...
          "&:after": {
            ...
            inset: 0,
            background:
              "linear-gradient(115deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0) 32%, rgba(255,255,255,0) 68%, rgba(255,255,255,0.16) 100%)",
            mixBlendMode: "overlay",
            opacity: 0.35,
            pointerEvents: "none",
        ...
        <Stack spacing={6} alignItems="center" sx={{ width: "100%" }}>
          ...
          <Stack spacing={2} alignItems="center">
            ...
            <Typography
              ...
              sx={{
                background:
                  "linear-gradient(90deg,#38f2a4 0%, #4ae46d 22%, #58d243 40%, #4fb3ff 63%, #c87dff 85%)",
          ...
          >
            <Button
              ...
              sx={{
                ...
                boxShadow:
                  "0 4px 12px -2px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.12) inset",
                transition: "all .35s cubic-bezier(.16,.84,.44,1)",
                "&:hover": {
                  background: "linear-gradient(145deg,#2fc79e 0%, #47d46b 45%, #66e751 100%)",
                  transform: "translateY(-2px)",
                  boxShadow:
                    "0 8px 18px -4px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.18) inset",
                },
                "&:active": {
            ...
            <Button
              ...
              sx={{
                ...
                color: "#e5f7ff",
                boxShadow:
                  "0 4px 12px -2px rgba(0,0,0,0.55), 0 0 0 1px rgba(255,255,255,0.15) inset",
                transition: "all .35s cubic-bezier(.16,.84,.44,1)",
                "&:hover": {
                  background: "linear-gradient(145deg,#16445a 0%, #16506a 50%, #1a6487 100%)",
                  transform: "translateY(-2px)",
                  boxShadow:
                    "0 8px 18px -4px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.22) inset",
                },
                "&:active": {
                  transform: "translateY(0)",
                  boxShadow: "0 4px 10px -2px rgba(0,0,0,0.55) inset",
