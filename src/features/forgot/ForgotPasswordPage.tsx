        ...
        {!sent && (
          ...
          >
            <TextField
              ...
              sx={fieldSx}
            />
            <Button type="submit" disabled={loading || !email} fullWidth sx={submitButtonSx}>
        ...
        {sent && (
          <Box textAlign="center" mt={2}>
            ...
            <Button
              component={RouterLink}
              to="/login"
              sx={{ mt: 3, color: "#4fb3ff", fontWeight: "bold", "&:hover": { color: "#38f2a4" } }}
            >
...
const submitButtonSx = {
  ...
  "&.Mui-disabled": { opacity: 0.5, color: "#0d1f2e" },
}
