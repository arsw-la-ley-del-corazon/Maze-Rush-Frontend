...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Halo animado detrás */}
      <Box sx={{ position: 'absolute', width: 520, height: 520, borderRadius: '50%', background: 'radial-gradient(circle,#38f2a422 0%, #38f2a400 70%)', filter: 'blur(40px)', animation: 'pulseRing 5s ease-in-out infinite', zIndex: 0 }} />
      ...
      <Button
        ...
        sx={{ position: 'absolute', top: 32, left: 32, color: 'rgba(255,255,255,0.7)', zIndex: 3, fontWeight: 'bold', textTransform: 'none', '&:hover': { color: '#fff' } }}
      >
        Volver
      </Button>
      ...
      <Paper
        elevation={0}
        sx={{
          width: '100%', maxWidth: 440, p: { xs: 3.5, sm: 5 }, position: 'relative', zIndex: 2,
            borderRadius: 4,
            ...
            '&:before': {
              content: '""', position: 'absolute', inset: 0,
              background: 'radial-gradient(circle at 30% 25%, rgba(255,255,255,0.12), transparent 65%)', opacity: 0.5, pointerEvents: 'none'
            },
            '&:after': {
              content: '""', position: 'absolute', inset: 0, pointerEvents: 'none',
              background: 'linear-gradient(120deg, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0) 28%, rgba(255,255,255,0) 72%, rgba(255,255,255,0.18) 100%)',
              mixBlendMode: 'overlay', opacity: 0.35, backgroundSize: '220% 100%',
              animation: 'sheen 11s linear infinite'
            },
            '@keyframes sheen': { '0%': { backgroundPosition: '0% 50%' }, '100%': { backgroundPosition: '120% 50%' } },
            '&:hover': { background: 'rgba(20,48,66,0.6)' }
        }}
      >
        <Typography variant="h4" fontWeight="bold" align="center" mb={1} sx={{
          background: 'linear-gradient(90deg,#38f2a4 0%, #4ae46d 22%, #48d43c 42%, #4fb3ff 68%, #c87dff 92%)',
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <TextField
            ...
            required
            InputProps={{ startAdornment: <EmailIcon sx={{ mr: 1, color: 'rgba(255,255,255,0.4)' }} /> }}
            fullWidth
            variant="outlined"
            sx={{
          ...
          <TextField
            ...
            required
            InputProps={{ startAdornment: <LockIcon sx={{ mr: 1, color: 'rgba(255,255,255,0.4)' }} /> }}
            fullWidth
            variant="outlined"
            sx={{
              '& .MuiOutlinedInput-root': {
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <FormControlLabel control={<Checkbox sx={{ color: 'rgba(255,255,255,0.4)', '&.Mui-checked': { color: '#38f2a4' } }} />} label={<Typography sx={{ color: 'rgba(255,255,255,0.7)' }}>Recordarme</Typography>} />
            <Button component={RouterLink} to="/forgot-password" variant="text" sx={{ color: '#4fb3ff', textTransform: 'none', fontWeight: 'bold', '&:hover': { color: '#38f2a4' } }}>
          ...
          <Button
            ...
            sx={{
              ...
              '&:before': {
                content: '""', position: 'absolute', inset: 0,
                background: 'linear-gradient(120deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0) 30%, rgba(255,255,255,0) 70%, rgba(255,255,255,0.35) 100%)',
                mixBlendMode: 'overlay', opacity: 0, transition: 'opacity .4s'
              },
              '&:hover': {
                background: 'linear-gradient(145deg,#2fc79e 0%, #47d46b 45%, #66e751 100%)',
                transform: 'translateY(-2px)',
                boxShadow: '0 8px 18px -4px rgba(0,0,0,0.65), 0 0 0 1px rgba(255,255,255,0.18) inset'
              },
        ...
        <Typography align="center" variant="body2" sx={{ color: 'rgba(255,255,255,0.7)' }}>
          ¿No tienes cuenta?{' '}
          <Button component={RouterLink} to="/signup" variant="text" sx={{ color: '#c87dff', fontWeight: 'bold', textTransform: 'none', '&:hover': { color: '#4fb3ff' } }}>
            Regístrate
          </Button>
        </Typography>
